			...
			<div class="essay">
			   <div class="guide">
			       ...
			       <a href="__APP__/Index/index">首页</a>
			        /
				   <a href="__APP__/<?php echo ($ParCol['code']); ?>"><?php echo ($ParCol['pname']); ?></a>
				   /	<strong><?php echo ($list['pname']); ?></strong>
			   </div>
			<hr>
			   <div class="list" style="margin-top:20px;">
			     <?php echo ($list['pdescribe']); ?>
					 <?php if(isset($showlist)): if(!empty($list['pdescribe'])): ?><h4 class="list-tips">列表</h4><?php endif; ?>  
						<ul class="list-title">
							<?php if(is_array($showlist)): $i = 0; $__LIST__ = $showlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$essay): $mod = ($i % 2 );++$i;?><li>
									<span><?php echo ($essay['ebuild']); ?></span>
									<a href="__APP__/Index/content/e/<?php echo ($essay['eid']); ?>" title="<?php echo ($essay['etitle']); ?>"><?php echo ($essay['etitle']); ?></a>
