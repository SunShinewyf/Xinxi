  ...
  <div id="header">
	...
	<ul>
	  ...
	  <!--left menu start-->
        ...
        <div class="menu">
            ...
            <ul class="menu">
				 <li><a href="__URL__/xyjj">学院简介</a></li>
				 <li><a href="__URL__/xyld">学院领导</a></li>
				 <li><a href="__URL__/zzjg">组织机构</a></li>
	...
	<!--right list start-->
	  <div class="right">
            ...
            <div class="essay">
			   <div class="guide">
			       ...
			       <a href="__APP__/Index/index">首页</a>
			        /
					<a href="__APP__/Xygk/xyjj">学院简介</a>
			        /
			        <strong>学院领导</strong>
			  </div>
			<hr>
			<div class="content">
			    <ul class="course">
				   <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="lead" style="font-size:20px;padding-left:18px;"><a href="__APP__/Xygk/information/t/<?php echo ($vo["tid"]); ?>"><?php echo ($vo["tname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			   </ul>
			</div>
	   </div>
	   <hr>
