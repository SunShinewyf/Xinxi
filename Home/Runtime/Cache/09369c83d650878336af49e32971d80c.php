...
<title>华中农业大学信息学院</title>
  ...
  <div id="header">
	...
	<ul>
	  ...
	  <!--left menu start-->
	    <div class="left">
            <div class="menu-title">学院领导</div>
            <ul class="tname">
				<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="nameList"><a href="__APP__/Xygk/information/t/<?php echo ($vo["tid"]); ?>"><?php echo ($vo["tname"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
		</div>
	<!--left menu end-->
	<!--right list start-->
            ...
            <div class="essay">
			   <div class="guide">
			       ...
			       <a href="__APP__/Index/index">首页</a>
			        /
					<a href="__APP__/Xygk/">学院概况</a>
			        /
			        <strong>学院领导</strong>
			  </div>
			<hr>
			<div class="content">
			   <div class="tname"><?php echo ($list["tname"]); ?></div>
			   <div class="tpic">
			     <img src="__UPLOADS__/Teacher/<?php echo ($list["tpic"]); ?>" style="width:200px;height:200px"/>
			   </div>
			   <div class="tinformation">
			      <?php echo ($list["tinformation"]); ?>
			   </div>
		    </div>
		</div>
		<hr>
