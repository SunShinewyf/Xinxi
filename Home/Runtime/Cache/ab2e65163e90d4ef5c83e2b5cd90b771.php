  ...
  <div id="header">
	...
	<!--right list start-->
	  <div class="right">
			...
			<div class="content">
			    <ul class="course">
				   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?><li style="font-size:20px;"><a href="__APP__/Szdw/Get_info/t/<?php echo ($re["tid"]); ?>"><?php echo ($re["tname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			   </ul>
			</div>
	   </div>
	   <hr>
