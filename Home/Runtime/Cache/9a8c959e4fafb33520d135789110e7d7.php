  ...
  <div id="header">
	...
	<!--right list start-->
	  <div class="right">
			...
			<h1 style="text-align:center;margin-top:20px;"><?php echo ($essay['etitle']); ?></h1>
			<p class="author" style="text-align:center;">文章来源:<?php echo ($essay['efrom']); ?>  &nbsp;发布日期:<?php echo ($essay['ebuild']); ?>  &nbsp; 阅读次数:<?php echo ($essay['etimes']); ?></p>
               <div class="content" style="margin-top:14px;text-indent:2em;">
